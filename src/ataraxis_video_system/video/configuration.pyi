...
_BOOLEAN_TRUE_VALUES: frozenset[str]
_BOOLEAN_FALSE_VALUES: frozenset[str]
_MAXIMUM_SELECTOR_COMBINATIONS: int
_RESET_PHASE_COUNT: int
...
def read_genicam_nodes(node_map: NodeMap, blacklisted_nodes: frozenset[str] = ...) -> list[GenicamNodeInfo]: ...
