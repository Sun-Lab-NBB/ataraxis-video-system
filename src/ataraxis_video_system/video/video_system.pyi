...
_PROCESS_INITIALIZATION_TIMEOUT: int
_PROCESS_INITIALIZATION_POLL_INTERVAL: int
_PROCESS_SHUTDOWN_TIME: int
_PROCESS_TERMINATION_TIME: int
...
class VideoSystem:
    ...
    _producer_process: BaseProcess | None
    _consumer_process: BaseProcess | None
...
def _empty_display_queue(display_queue: Queue) -> None: ...
