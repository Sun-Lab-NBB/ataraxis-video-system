...
def test_import_forces_the_xcb_qt_platform_on_a_wayland_session(monkeypatch) -> None:
    ...
    monkeypatch.setenv(name="WAYLAND_DISPLAY", value="wayland-probe")
    ...
    monkeypatch.setenv(name="QT_QPA_PLATFORM", value="operator-choice")
...
def test_import_preserves_the_qt_platform_outside_a_wayland_session(monkeypatch) -> None:
    ...
    monkeypatch.delenv(name="WAYLAND_DISPLAY", raising=False)
    monkeypatch.setenv(name="QT_QPA_PLATFORM", value="operator-choice")
